...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xd2dfeb });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x85a9c9 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x7e8e9b});
